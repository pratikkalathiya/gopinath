  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stock as @stock" do
        ...
        post :create, {:stock => { "company_id" => "invalid value" }}, valid_session
        expect(assigns(:stock)).to be_a_new(Stock)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stock" do
        ...
        expect_any_instance_of(Stock).to receive(:update).with({ "company_id" => "1" })
        put :update, {:id => stock.to_param, :stock => { "company_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stock as @stock" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Stock).to receive(:save).and_return(false)
        put :update, {:id => stock.to_param, :stock => { "company_id" => "invalid value" }}, valid_session
        expect(assigns(:stock)).to eq(stock)
      end
