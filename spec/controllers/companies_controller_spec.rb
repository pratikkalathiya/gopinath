  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved company as @company" do
        ...
        post :create, {:company => { "company_name" => "invalid value" }}, valid_session
        expect(assigns(:company)).to be_a_new(Company)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested company" do
        ...
        expect_any_instance_of(Company).to receive(:update).with({ "company_name" => "MyString" })
        put :update, {:id => company.to_param, :company => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the company as @company" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Company).to receive(:save).and_return(false)
        put :update, {:id => company.to_param, :company => { "company_name" => "invalid value" }}, valid_session
        expect(assigns(:company)).to eq(company)
      end
