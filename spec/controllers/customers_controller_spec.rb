...
describe CustomersController do
  ...
  let(:valid_attributes) { { "email_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved customer as @customer" do
        ...
        post :create, {:customer => { "email_id" => "invalid value" }}, valid_session
        expect(assigns(:customer)).to be_a_new(Customer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested customer" do
        ...
        expect_any_instance_of(Customer).to receive(:update).with({ "email_id" => "MyString" })
        put :update, {:id => customer.to_param, :customer => { "email_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the customer as @customer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Customer).to receive(:save).and_return(false)
        put :update, {:id => customer.to_param, :customer => { "email_id" => "invalid value" }}, valid_session
        expect(assigns(:customer)).to eq(customer)
      end
