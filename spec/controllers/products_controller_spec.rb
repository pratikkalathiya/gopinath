  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product as @product" do
        ...
        post :create, {:product => { "company_id" => "invalid value" }}, valid_session
        expect(assigns(:product)).to be_a_new(Product)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product" do
        ...
        expect_any_instance_of(Product).to receive(:update).with({ "company_id" => "1" })
        put :update, {:id => product.to_param, :product => { "company_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the product as @product" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Product).to receive(:save).and_return(false)
        put :update, {:id => product.to_param, :product => { "company_id" => "invalid value" }}, valid_session
        expect(assigns(:product)).to eq(product)
      end
